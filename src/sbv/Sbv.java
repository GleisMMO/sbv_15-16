...
*    * Anfang Komponenten
*    
*    jLabel1.setBounds(8, 40, 131, 25);
*    jLabel1.setText("Benutzername");
*    cp.add(jLabel1);
*    jLabel2.setBounds(8, 96, 131, 25);
*    jLabel2.setText("Passwort");      
*    cp.add(jLabel2);
*    username.setBounds(176, 48, 97, 17);
*    cp.add(username);
*    passwort.setBounds(176, 96, 97, 17);
*    cp.add(passwort);
*    passwort.setColumns(9);
...
*    });
*    
*    erfolg.setBounds(48, 192, 201, 25);
*    cp.add(erfolg);
*    login.setBounds(104, 152, 89, 17);
...
*      erfolg.setText("Erfolgreich");
*       Oberflaeche.main(args);
*       setVisible(false);
*    } else {
*      erfolg.setText("Invalid User Data");
*    } * end of if-else
